#!/bin/bash
#SBATCH --job-name=ysy_corot-5s-c2048
...
OUT_ROOT="${PROJECT_DIR}/outputs/finetune_5step_c2048"
...
echo "============================================================"
echo "5-step C2048 differentiable fine-tune FORMAL"
echo "V2_RUN=${V2_RUN}"
...
printf '%s\n' "${RUN_DIR}" > "${PROJECT_DIR}/finetune_5step_c2048_latest.txt"
echo "RUN_DIR=${RUN_DIR}"
